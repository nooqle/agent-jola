...
```bash
pnpm agent:setting write --yes --cloud-url https://agentpoppy.example.com --api-key <product-api-key> --agent <name> --provider openai --model gpt-4.1 --openai-key <local-openai-key>
